...
public class Ex14 {
	...
	public static void main(String[] args) {
		...
		String[][] quiz = {
				...
				{ "De quem é a famosa frase “Penso, logo existo”?", "Platão", "Galileu Galilei", "Descartes",
						"Sócrates", "4" },
				{ "Qual o livro mais vendido no mundo a seguir à Bíblia? ", "O Senhor dos Anéis", "Dom Quixote",
						"O Pequeno Príncipe", "Ela, a Feiticeira", "2" },
