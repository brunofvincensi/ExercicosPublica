...
public class Ex15 {
	...
	public static double calculaMedia(String nota1, String nota2, String nota3) {
		double media = (Double.parseDouble(nota1) + Double.parseDouble(nota2) + Double.parseDouble(nota3)) / 3.0;
		...
		while (continuar) {
			...
			case '3': {
				...
				if (indice == -1) {
					...
					alunos[indice][2] = Double.toString(novaNota1);
					alunos[indice][3] = Double.toString(novaNota2);
					alunos[indice][4] = Double.toString(novaNota3);
