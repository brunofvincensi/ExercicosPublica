...
public class Ex10 {
	...
	public static void main(String[] args) {
		...
		if (ladoEsquerdo == ladoDireito && ladoEsquerdo == ladoInferior && ladoInferior == ladoDireito) {

			System.out.println("Equilatero");
		} else if (ladoEsquerdo == ladoDireito || ladoEsquerdo == ladoInferior || ladoInferior == ladoDireito) {
